...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col bg-just_white">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-just_white border-b border-just_black-5">
        <div className="mx-auto flex h-16 items-center justify-between px-8">
          {/* Logo */}
          <div className="flex items-center">
            <div className="text-2xl font-bold text-just_cod-gray">
              JustTalk
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-2">
            <a href="#about" className="px-[10px] py-[6px] rounded-lg text-just_scorpion text-base font-normal tracking-[-0.14px] hover:bg-just_black-5 transition-colors">
              About
            </a>
            <a href="#features" className="px-[10px] py-[6px] rounded-lg text-just_scorpion text-base font-normal tracking-[-0.14px] hover:bg-just_black-5 transition-colors">
              Features
            </a>
            <a href="#pricing" className="px-[10px] py-[6px] rounded-lg text-just_scorpion text-base font-normal tracking-[-0.14px] hover:bg-just_black-5 transition-colors">
              Pricing
            </a>
          </nav>
      ...
      <main className="flex flex-col items-center w-full">
        ...
        <section className="w-full max-w-[1186px] px-10 py-16 md:py-24">
          ...
          <div className="relative w-full rounded-2xl overflow-hidden bg-gradient-to-br from-blue-200 via-blue-300 to-purple-200 p-9">
            <div className="aspect-video flex items-center justify-center text-just_white/50 text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mb-24">
            ...
            <div className="relative w-full aspect-square rounded-2xl bg-gradient-to-br from-purple-200 to-pink-200 p-6 flex flex-col gap-4 justify-center">
              <div className="flex gap-4 justify-center">
                {[1, 2].map((i) => (
                  <div key={i} className="bg-just_white border border-[#f3f3f3] rounded-[32px] p-2 shadow-md w-[200px]">
      ...
      <footer className="w-full border-t border-just_cod-gray-5">
        <div className="mx-auto max-w-[1536px] px-4 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {/* Logo */}
            <div>
              <div className="text-2xl font-bold text-just_cod-gray">JustTalk</div>
            </div>
          ...
          <div className="overflow-hidden mb-12">
            <a href="#" className="block">
              <div className="text-[180px] md:text-[280.9px] font-bold leading-[288.75px] tracking-[-5.775px] text-just_cod-gray hover:opacity-80 transition-opacity">
                JustTalk
              </div>
              <div className="text-[180px] md:text-[260.5px] font-bold leading-[265.31px] tracking-[-3.98px] text-just_cod-gray flex items-center hover:opacity-80 transition-opacity">
                Try now <span className="text-[200px] md:text-[265.3px] ml-4">→</span>
              </div>
            </a>
          </div>
